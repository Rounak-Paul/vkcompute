/**
 * VKCompute - Chapter 10: Debugging and Profiling
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Chapter 10: Debugging\n");
    printf("==============================================\n\n");
    ...
    config.app_name = "CH10 Debugging";
    ...
    char* shader_path = vkc_path_relative_to_exe("shaders/ch10_debugging/compute.comp.spv");
