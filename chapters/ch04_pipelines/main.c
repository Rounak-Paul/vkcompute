/**
 * VKCompute - Chapter 04: Pipeline Management
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Chapter 04: Pipeline Management\n");
    printf("==============================================\n\n");
    ...
    for (int i = 0; i < OP_COUNT; i++) {
        ...
        snprintf(shader_file, sizeof(shader_file), "shaders/ch04_pipelines/%s", op_shaders[i]);
