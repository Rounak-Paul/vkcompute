/**
 * VKCompute - Episode 02: Buffer Types and Staging
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Episode 02: Buffer Types\n");
    printf("==============================================\n\n");
    
    // Initialize Vulkan
    VkcContext ctx;
    VkcConfig config = vkc_config_default();
    config.app_name = "EP02 Buffers";
    ...
    char* shader_path = vkc_path_relative_to_exe("shaders/ep02_buffers/square.comp.spv");
