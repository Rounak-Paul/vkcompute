/**
 * VKCompute - Episode 05: Synchronization
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Episode 05: Synchronization\n");
    printf("==============================================\n\n");
    ...
    // Load shader
    char* shader_path = vkc_path_relative_to_exe("shaders/ep05_synchronization/increment.comp.spv");
