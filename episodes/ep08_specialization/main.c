/**
 * VKCompute - Episode 08: Specialization Constants
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Episode 08: Specialization\n");
    printf("==============================================\n\n");
    ...
    char* shader_path = vkc_path_relative_to_exe("shaders/ep08_specialization/compute.comp.spv");
