/**
 * VKCompute - Episode 03: Descriptor Sets Deep Dive
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Episode 03: Descriptor Sets\n");
    printf("==============================================\n\n");
    ...
    char* shader_path = vkc_path_relative_to_exe("shaders/ep03_descriptors/transform.comp.spv");
