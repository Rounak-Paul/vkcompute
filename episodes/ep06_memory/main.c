/**
 * VKCompute - Episode 06: Memory Management
 * 
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  VKCompute - Episode 06: Memory Management\n");
    printf("==============================================\n\n");
    ...
    char* shader_path = vkc_path_relative_to_exe("shaders/ep06_memory/double.comp.spv");
